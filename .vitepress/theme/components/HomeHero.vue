  ...
  <header v-if="showHero" class="home-hero flex">
    <div class="mx-auto grid lg:grid-cols-[minmax(400px,600px),minmax(500px,800px)] gap-4">
      <div class="my-auto pb-40 <md:pb-26">
        <p align="center">
          <a href="https://github.com/kolibry-js/kolibry">
            <img src="/logo-title.png" alt="Kolibry" height="300" />
          </a>
          <br />
        </p>
        ...
        <a href="https://github.com/kolibry-js/kolibry" class="mt-3 block filter dark:invert" target="__blank">
          <img alt="GitHub stars" src="https://img.shields.io/github/stars/kolibry-js/kolibry?style=social" />
        </a>
      </div>
      <ClientOnly>
