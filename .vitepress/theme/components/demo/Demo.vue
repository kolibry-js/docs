...
// @ts-ignore
import Cover from '@kolibry/theme-default/layouts/cover.vue'
import { parse } from '@kolibry/parser'
import Default from '@kolibry/client/layouts/default.vue'
import Center from '@kolibry/client/layouts/center.vue'
import SlideContainer from '@kolibry/client/internals/SlideContainer.vue'
import '@kolibry/client/styles/layouts-base.css'
import '@kolibry/theme-default/styles/layouts.css'

const page = ref(0)
const paused = ref(false)
const code = ref('')
const info = ref<KolibryMarkdown>()
...
const COVER_URL = 'https://kolibry.dev/demo-cover.jpg'
...
onMounted(() => {
  new TypeIt(block.value, {
    ...
    .type('<br><span class="token title"># Welcome to Kolibry!</span><br><br>', { delay: 400 })
