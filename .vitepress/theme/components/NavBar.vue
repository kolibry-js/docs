<template>
  <header class="nav-bar" :class="{'no-toggle-btn': !showSidebar}">
    ...
    <div class="nav-icons mr-2">
      <div class="item">
        <a class="nav-btn" href="https://nyxb.chat" target="_blank" aria-label="Discord">
          <ri-discord-fill />
        </a>
      </div>

      <div class="item">
        <a class="nav-btn" href="https://twitter.com/nyxb0" target="_blank" aria-label="Twitter">
          <ri-twitter-fill />
        </a>
      </div>

      <div v-if="repo" class="item">
        <a class="nav-btn" href="https://github.com/kolibry-js/kolibry" target="_blank" aria-label="View GitHub Repo">
          <ri-github-fill />
        </a>
      </div>
