...
If the language you want to contribute isn't on the list, join [our Discord server](https://nyxb.chat), and find the `#translations` channel to see if someone is already working on the language you want, consider joining them and translate together. If not, you can start a new translation project with the following steps.
...
- [ ] Fork the main docs repo: [kolibry-js/docs](https://github.com/kolibry-js/docs)
...
- [ ] `showcases.md` - A gallery showcase of Kolibry presentations.
...
- [ ] `components.md` - Use [Vue components](https://v3.vuejs.org/guide/component-basics.html) inside Kolibry
- [ ] `layouts.md` - Use Vue layouts inside Kolibry
...
- [ ] `index.md` - Getting started with Kolibry
...
- [ ] `why.md` - _Why Kolibry?_

### resources/

- [ ] `covers.md` - Curated covers for Kolibry

### themes/

- [ ] `gallery.md` - Theme gallery
- [ ] `use.md` - How to use Kolibry themes
- [ ] `write-a-theme.md` - Write your own theme

### addons/

- [ ] `use.md` - How to use Kolibry addons
- [ ] `write-an-addon.md` - Write your own addon

## Publishing your translations

- [ ] When you finish the translation (at least 90%), `@nyxb` in the Discord and we will invite you to the org and make the translation official.
...
- [ ] The site is live, and we will send a shout-out tweet on [our Twitter account](https://twitter.com/nyxb0).
...
[Working-in-progress translation list](https://discord.com/channels/1113511184663056404/1179010264641851444)
