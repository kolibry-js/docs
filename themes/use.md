...
Changing the theme in Kolibry is surprisingly easy. All you need to do is to add the `theme:` field in your frontmatter.
...
> **Note**
> To install a theme from a scoped package, you will have to give the full namespace e.g `@organization/kolibry-theme-name`

You can start the server, which will prompt you to install the theme automatically

<div class="language-md">
<pre>
<span class="token keyword">?</span> The theme <span class="token string">"@kolibry/theme-seriph"</span> was not found in your project, do you want to install it now? › (Y/n)
</pre>
</div>
...
```bash
$ npm install @kolibry/theme-seriph
```
